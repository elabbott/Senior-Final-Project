...
class PaymentInfosControllerTest < ActionController::TestCase
  ...
  test "should create payment_info" do
    assert_difference('PaymentInfo.count') do
      post :create, payment_info: { c_type: @payment_info.c_type, cnum: @payment_info.cnum, cvv: @payment_info.cvv, expdate: @payment_info.expdate, name: @payment_info.name }
    end
  ...
  test "should update payment_info" do
    patch :update, id: @payment_info, payment_info: { c_type: @payment_info.c_type, cnum: @payment_info.cnum, cvv: @payment_info.cvv, expdate: @payment_info.expdate, name: @payment_info.name }
    assert_redirected_to payment_info_path(assigns(:payment_info))
  end
